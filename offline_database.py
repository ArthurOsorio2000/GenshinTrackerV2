...
# cursor.execute("""CREATE TABLE  offline_weapon_types(
...
# cursor.execute("""CREATE TABLE  offline_regions(
...
# cursor.execute("""CREATE TABLE  offline_talent_books(
...
# cursor.execute("""CREATE TABLE offline_character_templates(
...
#     region_id INT NOT NULL,
#     PRIMARY KEY(char_id),
#     FOREIGN KEY (talent_id) REFERENCES offline_talent_books(talent_id),
#     FOREIGN KEY (weapon_id) REFERENCES offline_weapon_types(weapon_id),
#     FOREIGN KEY (region_id) REFERENCES offline_regions(region_id)
# );""")
...
# cursor.execute("""CREATE TABLE offline_user_characters(
...
#     FOREIGN KEY (user_id) REFERENCES offline_user_profiles(user_id),
# 	FOREIGN KEY (char_id) REFERENCES offline_character_templates(char_id)
# );""")
